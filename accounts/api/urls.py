...
from accounts.api.status_views import HttpStatusCatalogView, HttpStatusDemoView
...
urlpatterns = [
    ...
    # ── HTTP Status (справочник кодов) ────────────────────────────────────────
    path("reference/http-status/", HttpStatusCatalogView.as_view(), name="api_http_status_catalog"),
    path("reference/http-status/<int:code>/", HttpStatusDemoView.as_view(), name="api_http_status_demo"),
]
